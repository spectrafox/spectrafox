Public Class cExportMethod_Ascii_SPACE
    Inherits cExportMethod_Ascii

    Public Overrides Function ExportDescription() As String
        Return My.Resources.rExportMethods.ExportTypeDesc_SPACE
    End Function
    ...
    Public Overrides Function ExportName() As String
        Return My.Resources.rExportMethods.ExportTypeName_SPACE & " (" & Me.FileExtension & ")"
    End Function
End Class
