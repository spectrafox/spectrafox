...
Public Class cFileImportNanonisZ
    Inherits cFileImportNanonisSpectroscopyFile
    ' JUST IGNORE OTHER FILES --> centralized with cFileImportNanonisSpectroscopyFile
    ...
    '''' <summary>
    '''' Imports the Z-Spectroscopy-File into a Spectroscopy Table
    '''' </summary>
    ...
    '                    Case "Z offset (m)"
    '                        .Z_Offset = Double.Parse(sPropertyValue, Globalization.CultureInfo.InvariantCulture)
    ...
    '                If lColumns(0).Values.Count <> oSpectroscopyTable.MeasurementPoints Then
    '                    oSpectroscopyTable.MeasurementPoints = lColumns(0).Values.Count
    '                End If
    '            End If
    ...
    '            ' Save Number of Measurement-Points
    '            If oSpectroscopyTable.MeasurementPoints = 0 Then oSpectroscopyTable.MeasurementPoints = oColumn.Values.Count
    '        Next
    ...
    '    If ReaderBuffer.Contains("Z spectroscopy") Then
    '        Return True
    '    End If
