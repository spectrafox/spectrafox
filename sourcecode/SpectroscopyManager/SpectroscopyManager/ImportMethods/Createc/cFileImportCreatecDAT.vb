...
Public Class cFileImportCreatecDAT
    ...
    Public Function ImportDAT(ByRef FullFileNamePlusPath As String,
        ...
        Using fs As New FileStream(FullFileNamePlusPath, FileMode.Open, FileAccess.Read, FileShare.Read)
            ...
            Using sr As New StreamReader(fs, System.Text.Encoding.ASCII)
                ...
                If Not FetchOnlyFileHeader Then
                    ...
                    Using br As BinaryReader = New BinaryReader(fs, System.Text.Encoding.UTF8)
