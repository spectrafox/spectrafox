...
Public Class cFileImportCreatecVERT
    ...
    Public Function ImportBias(ByRef FullFileNamePlusPath As String,
        ...
        Using sr As New StreamReader(FullFileNamePlusPath)
            ...
            ' Invert all backward channels 
            For Each ColumnKV As KeyValuePair(Of Integer, cSpectroscopyTable.DataColumn) In lSortedColumnList
                If ColumnKV.Key >= 100 Then
                    ColumnKV.Value.SetValueList(ColumnKV.Value.Values(True).Reverse.ToList)
                End If
            Next
