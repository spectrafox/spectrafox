...
Public Class cFileImportOmicronMatrix
    ...
    Public Function ImportBias(ByRef FullFileNamePlusPath As String,
        ...
        PointColumn.Index = lColumns.Count
        PointColumn.Name = "Measurement Point"
            ...
            Do Until sr.EndOfStream
                ...
                For i As Integer = 0 To SplittedLine.Length - 1 Step 1
                    ...
                    If Double.TryParse(SplittedLine(i), NumberStyles.Float, CultureInfo.InvariantCulture, ParsedDouble) Then
                        lColumns(i).Values.Add(ParsedDouble)
                    Else
                ...
                lColumns(PointColumnIndex).Values.Add(iRowCounter)
        ...
        For Each oColumn As cSpectroscopyTable.DataColumn In lColumns
            oSpectroscopyTable.AddColumn(oColumn)
        Next
    ...
    Public Const ImageFileIdentifier As String = "ONTMATRX0101TLKB"
    ...
    Public Function IdentifyFile(ByRef FullFileNamePlusPath As String,
        ...
        If ReaderBuffer.Contains(FileIdentifier) Or
           ReaderBuffer.Contains(ImageFileIdentifier) Or
           ReaderBuffer.Contains(ParameterFileIdentifier) Then
            Return True
        End If
