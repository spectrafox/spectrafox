...
Public Interface iFitProcedureMultipleDataFit
...
#Region "Fit-Procedure-Properties"
    ...
    ''' <summary>
    ''' Returns the parameter set of the current Fit of the first data set.
    ''' </summary>
    ReadOnly Property FitParameters_Set1() As Dictionary(Of Integer, sFitParameter)

    ''' <summary>
    ''' Returns the parameter set of the current Fit of the second data set.
    ''' </summary>
    ReadOnly Property FitParameters_Set2() As Dictionary(Of Integer, sFitParameter)
...
#Region "Events"
    ...
    ''' </summary>
    Event FitStepEcho(ByVal FinalParameters_Set1 As Dictionary(Of Integer, sFitParameter),
                      ByVal FinalParameters_Set2 As Dictionary(Of Integer, sFitParameter),
    ...
    Event FitFinished(ByVal FitStopReason As Integer,
                      ByVal FinalParameters_Set1 As Dictionary(Of Integer, sFitParameter),
                      ByVal FinalParameters_Set2 As Dictionary(Of Integer, sFitParameter),
                      ByVal Chi2_Set1 As Double,
                      ByVal Chi2_Set2 As Double)
...
#Region "Fitting and Aborting"
    ...
    Function FitAsync(ByVal ModelFitFunction_Set1 As iFitFunction,
    ...
    ''' a new array is created with all elements set to 1.</param>
    ''' </summary>
    Sub DirectFit(ByVal ModelFitFunction_Set1 As iFitFunction,
                  ByVal ModelFitFunction_Set2 As iFitFunction,
                  ByVal FitDataPoints_Set1 As Double()(),
                  ByVal FitDataPoints_Set2 As Double()(),
                  ByVal Weights_Set1 As Double(),
