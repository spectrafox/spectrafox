Public Class cFitSettingPanel_Lorentz
...
#Region "Constructor"
    ...
    Protected Overrides Function BindFitParameters() As Boolean
        ...
        Dim CurrentIdentifier As cFitFunction_Lorentz.FitParameterIdentifier

        ' apply the last settings
        CurrentIdentifier = cFitFunction_Lorentz.FitParameterIdentifier.Area
        ...
        CurrentIdentifier = cFitFunction_Lorentz.FitParameterIdentifier.Width
        ...
        CurrentIdentifier = cFitFunction_Lorentz.FitParameterIdentifier.Y0
        ...
        CurrentIdentifier = cFitFunction_Lorentz.FitParameterIdentifier.XCenter
        ...
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_Lorentz.FitParameterIdentifier.Area.ToString, Me.fpAmplitude)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_Lorentz.FitParameterIdentifier.Width.ToString, Me.fpWidth)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_Lorentz.FitParameterIdentifier.XCenter.ToString, Me.fpXCenter)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_Lorentz.FitParameterIdentifier.Y0.ToString, Me.fpYOffset)

        MyBase.RegisterLockedFitParameterOnMultipleFit(cFitFunction_Lorentz.FitParameterIdentifier.Y0.ToString, 0D)
