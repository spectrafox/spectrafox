...
Namespace My.Resources
    ...
    Friend Class rFitFunction_Exponential
        ...
        Friend Shared ReadOnly Property ResourceManager() As Global.System.Resources.ResourceManager
            Get
                If Object.ReferenceEquals(resourceMan, Nothing) Then
                    Dim temp As Global.System.Resources.ResourceManager = New Global.System.Resources.ResourceManager("SpectroscopyManager.rFitFunction_Exponential", GetType(rFitFunction_Exponential).Assembly)
                    resourceMan = temp
                End If
                Return resourceMan
            End Get
        ...
        '''<summary>
        '''  Looks up a localized string similar to Exponential decay or growth..
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to Y0 + A * exp(-(x - Xc) / T).
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to Exponential Function.
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to (T) Decay.
        '''</summary>
        Friend Shared ReadOnly Property Parameter_Decay() As String
            Get
                Return ResourceManager.GetString("Parameter_Decay", resourceCulture)
            End Get
        End Property
