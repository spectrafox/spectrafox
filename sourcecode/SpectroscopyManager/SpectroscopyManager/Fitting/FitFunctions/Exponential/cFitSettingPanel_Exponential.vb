Public Class cFitSettingPanel_Exponential
...
#Region "Constructor"
    ...
    Protected Overrides Function BindFitParameters() As Boolean
        ...
        Dim CurrentIdentifier As cFitFunction_Exponential.FitParameterIdentifier

        ' apply the last settings
        CurrentIdentifier = cFitFunction_Exponential.FitParameterIdentifier.Amplitude
        ...
        CurrentIdentifier = cFitFunction_Exponential.FitParameterIdentifier.Decay
        Me.fpDecay.BindToFitParameter(Me._FitFunction.FitParameters.Parameter(CurrentIdentifier.ToString), Me._FitFunction.FitParametersGrouped)

        CurrentIdentifier = cFitFunction_Exponential.FitParameterIdentifier.Y0
        ...
        CurrentIdentifier = cFitFunction_Exponential.FitParameterIdentifier.XCenter
        ...
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_Exponential.FitParameterIdentifier.Amplitude.ToString, Me.fpAmplitude)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_Exponential.FitParameterIdentifier.Decay.ToString, Me.fpDecay)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_Exponential.FitParameterIdentifier.XCenter.ToString, Me.fpXCenter)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_Exponential.FitParameterIdentifier.Y0.ToString, Me.fpYOffset)

        MyBase.RegisterLockedFitParameterOnMultipleFit(cFitFunction_Exponential.FitParameterIdentifier.Y0.ToString, 0D)
...
#Region "Parameter-Selection by Range-Selection"
    ...
    Private Sub ChangeWidthFromXRange(LeftValue As Double, RightValue As Double)
        Me.fpDecay.SetValue(RightValue - LeftValue)
