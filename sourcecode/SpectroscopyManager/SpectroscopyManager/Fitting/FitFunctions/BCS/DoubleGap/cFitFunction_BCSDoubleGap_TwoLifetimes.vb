...
Public Class cFitFunction_BCSDoubleGap_TwoLifetimes
...
#End Region
    ...
    Public Overrides Function GetCudaCompileClasses() As List(Of Type)
        ...
        ReturnList.Add(GetType(cFitFunction_BCSDoubleGap_TwoLifetimes))
        Return ReturnList
    End Function
        ...
        Return InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSBase.BCSAmplitude.ToString).Value * _
               ...
               * BCSFunc(E,
               ...
               + BCSFunc(E,
                         ...
                         0,
                         0,
                         InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.ImaginaryDamping2.ToString).Value))
    End Function
    ...
    Public Function TipDOSCUDA(ByVal E As Double, ByRef InputParameters As cFitParameterGroupGroup) As Double
        Return BCSFunc(E,
                       ...
                       0,
                       0,
                       InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.ImaginaryDampingTip.ToString).Value)
    End Function
    ...
    Public Function SampleDOSSeparated2(ByRef E As Double, ByRef InputParameters As cFitParameterGroupGroup) As Double
        Return BCSFunc(E, InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.Delta_Sample2.ToString).Value,
                         0, 0, InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.ImaginaryDamping2.ToString).Value)
    End Function
...
#Region "Fit-Description and Formula"
    ...
    Public Overrides Function FitFunctionName() As String
        Return My.Resources.rFitFunction_BCSDoubleGap.Name_TwoLifetimes
    End Function
    ...
    Public Overrides Function FitDescription() As String
        Return My.Resources.rFitFunction_BCSDoubleGap.Description_TwoLifetimes
    End Function
...
#Region "Fit-Settings-Panel"
    ...
    Overrides ReadOnly Property FunctionSettingPanel As cFitSettingPanel
        Get
            Return New cFitSettingPanel_BCSDoubleGap_TwoLifetimes
        End Get
    End Property
#End Region
