...
Public Class cFitFunction_BCSDoubleGap_TipAndSample
...
#Region "Initialize Fit-Parameters"
    ...
    Protected Overrides Sub InitializeFitParameters()
        Me.FitParameters.Add(New cFitParameter(FitParameterIdentifierBCSDoubleGap.Delta_Tip1.ToString, 0.00136, True, My.Resources.rFitFunction_BCSDoubleGap.Parameter_Delta_Tip1))
        Me.FitParameters.Add(New cFitParameter(FitParameterIdentifierBCSDoubleGap.Delta_Tip2.ToString, 0.00136, True, My.Resources.rFitFunction_BCSDoubleGap.Parameter_Delta_Tip2))
        ...
        Me.FitParameters.Add(New cFitParameter(FitParameterIdentifierBCSDoubleGap.RatioTip1ToTip2.ToString, 0.1, False, My.Resources.rFitFunction_BCSDoubleGap.Parameter_RatioTip1ToTip2))
...
#End Region
    ...
    Public Overrides Function GetCudaCompileClasses() As List(Of Type)
        ...
        ReturnList.Add(GetType(cFitFunction_BCSDoubleGap_TipAndSample))
        Return ReturnList
    End Function
    ...
    Public Function TipDOSCUDA(ByVal E As Double, ByRef InputParameters As cFitParameterGroupGroup) As Double
        Return (InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.RatioTip1ToTip2.ToString).Value _
               * BCSFunc(E,
                         InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.Delta_Tip1.ToString).Value,
                         0,
                         0,
                         InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSBase.ImaginaryDamping.ToString).Value) _
               + BCSFunc(E,
                         InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.Delta_Tip2.ToString).Value,
                         0,
                         0,
                         InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSBase.ImaginaryDamping.ToString).Value))
    End Function
    ...
    ''' <summary>
    ''' Separated Tip-DOS for data generation functions
    ''' </summary>
    Public Function TipDOSSeparated1(ByRef E As Double, ByRef InputParameters As cFitParameterGroupGroup) As Double
        Return InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.RatioTip1ToTip2.ToString).Value _
               * BCSFunc(E, InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.Delta_Tip1.ToString).Value,
                         0, 0, InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSBase.ImaginaryDamping.ToString).Value)
    End Function
    ...
    ''' Separated Tip-DOS for data generation functions
    ''' </summary>
    Public Function TipDOSSeparated2(ByRef E As Double, ByRef InputParameters As cFitParameterGroupGroup) As Double
        Return BCSFunc(E, InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSDoubleGap.Delta_Tip2.ToString).Value,
                       0, 0, InputParameters.Group(Me.UseFitParameterGroupID).Parameter(FitParameterIdentifierBCSBase.ImaginaryDamping.ToString).Value)
    End Function
    ...
    Public Overrides Sub RegisterDataGenerationFunction()
        ...
        Me.AdditionalDataGenerationFunctions.Add(My.Resources.rFitFunction_BCSDoubleGap.GeneratedDataFunctionName_TipDOS1, AddressOf TipDOSSeparated1)
        Me.AdditionalDataGenerationFunctions.Add(My.Resources.rFitFunction_BCSDoubleGap.GeneratedDataFunctionName_TipDOS2, AddressOf TipDOSSeparated2)
...
#Region "Fit-Description and Formula"
    ...
    Public Overrides Function FitFunctionName() As String
        Return My.Resources.rFitFunction_BCSDoubleGap.Name_TipAndSample
    End Function
    ...
    Public Overrides Function FitDescription() As String
        Return My.Resources.rFitFunction_BCSDoubleGap.Description_TipDoubleGap
    End Function
...
#Region "Fit-Settings-Panel"
    ...
    Overrides ReadOnly Property FunctionSettingPanel As cFitSettingPanel
        Get
            Return New cFitSettingPanel_BCSDoubleGap_TipAndSample
        End Get
    End Property
#End Region
