...
Public Class cFitFunction_BCSDoubleGap_InelasticChannel
...
#End Region
    ...
    Public Overrides Function GetCudaCompileClasses() As List(Of Type)
        ...
        ReturnList.Add(GetType(cFitFunction_BCSDoubleGap_InelasticChannel))
        Return ReturnList
    End Function
    ...
    Public Overrides Sub RegisterDataGenerationFunction()
        ...
        Me.AdditionalDataGenerationFunctions.Add(My.Resources.rFitFunction_BCSDoubleGap_InelasticChannel.GeneratedDataFunctionName_SampleDOS1, AddressOf SampleDOSSeparated1)
        Me.AdditionalDataGenerationFunctions.Add(My.Resources.rFitFunction_BCSDoubleGap_InelasticChannel.GeneratedDataFunctionName_SampleDOS2, AddressOf SampleDOSSeparated2)
    End Sub
...
#Region "Fit-Description and Formula"
    ...
    Public Overrides Function FitFunctionFormula() As String
        Return My.Resources.rFitFunction_BCSDoubleGap_InelasticChannel.Formula
    End Function
    ...
    Public Overrides Function FitFunctionName() As String
        Return My.Resources.rFitFunction_BCSDoubleGap_InelasticChannel.Name
    End Function
    ...
    Public Overrides Function FitDescription() As String
        Return My.Resources.rFitFunction_BCSDoubleGap_InelasticChannel.Description
    End Function
    ...
    Public Overrides Function FitFunctionAuthors() As String
        Return My.Resources.rFitFunction_BCSDoubleGap_InelasticChannel.Authors
    End Function
#End Region
...
#Region "Fit-Settings-Panel"
    ...
    Overrides ReadOnly Property FunctionSettingPanel As cFitSettingPanel
        Get
            Return New cFitSettingPanel_BCSDoubleGap_InelasticChannel
        End Get
    End Property
#End Region
