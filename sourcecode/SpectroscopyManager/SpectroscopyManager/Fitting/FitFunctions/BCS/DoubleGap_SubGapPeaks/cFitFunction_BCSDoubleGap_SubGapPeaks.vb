...
#Region "Initialize Fit-Parameters"
    ...
    Protected Overrides Sub InitializeFitParameters()
        Me.FitParameters.Add(New cFitParameter(FitParameterIdentifierBCSDoubleGap.Delta_Tip.ToString, 0.00136, True, My.Resources.rFitFunction_BCSDoubleGap_SubGapPeaks.Parameter_Delta_Tip))
        ...
        Me.FitParameters.Add(New cFitParameter(FitParameterIdentifierBCSDoubleGap.Delta_Sample2.ToString, 0.00128, False, My.Resources.rFitFunction_BCSDoubleGap_SubGapPeaks.Parameter_Delta_Sample2))
