Public Class cFitSettingPanel_BCSDoubleGap_SubGapPeaks
...
#Region "Constructor"
    ...
    Protected Overrides Function BindFitParameters() As Boolean
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.SystemBroadening.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSDoubleGap.Delta_Sample1.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSDoubleGap.Delta_Sample2.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSDoubleGap.Delta_Tip.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.GlobalXOffset.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.GlobalYOffset.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSBase.BCSAmplitude.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSBase.ImaginaryDamping.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSDoubleGap.RatioSample1ToSample2.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.T_sample.ToString
        ...
        CurrentIdentifier = cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.T_tip.ToString
        ...
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.SystemBroadening.ToString, Me.fpBroadeningWidth)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSDoubleGap.Delta_Sample1.ToString, Me.fpSampleGap1)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSDoubleGap.Delta_Sample2.ToString, Me.fpSampleGap2)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSDoubleGap.Delta_Tip.ToString, Me.fpTipGap)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.GlobalXOffset.ToString, Me.fpXOffset)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.GlobalYOffset.ToString, Me.fpYOffset)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSBase.BCSAmplitude.ToString, Me.fpAmplitude)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSBase.ImaginaryDamping.ToString, Me.fpImaginaryDamping)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifierBCSDoubleGap.RatioSample1ToSample2.ToString, Me.fpSampleGapRatio)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.T_sample.ToString, Me.fpSampleTemperature)
        MyBase.RegisterFitParameterSettingsBox(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.T_tip.ToString, Me.fpTipTemperature)

        MyBase.RegisterLockedFitParameterOnMultipleFit(cFitFunction_BCSDoubleGap_SubGapPeaks.FitParameterIdentifier.GlobalYOffset.ToString, 0D)
