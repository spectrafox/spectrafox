...
Partial Class cFitSettingPanel_IETS_SpinExcitation
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.fpMagneticFieldAngleTheta.DecimalValue = 0.0R
        ...
        Me.fpMagneticFieldAngleTheta.TabIndex = 24
        Me.fpMagneticFieldAngleTheta.Value = 0.0R
        '
        'fpMagneticField
        '
        ...
        '
        Me.fpMagneticFieldAnglePhi.DecimalValue = 0.0R
        ...
        Me.fpMagneticFieldAnglePhi.TabIndex = 24
        Me.fpMagneticFieldAnglePhi.Value = 0.0R
        '
