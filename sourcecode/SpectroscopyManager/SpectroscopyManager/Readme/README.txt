CUDAfy .NET SDK V1.22 - General Purpose GPU programming for .NET
...
Download and install in default locations the CUDA Toolkit 5.0 RC from http://developer.nvidia.com/cuda-toolkit-sdk
