Public Class cDataBrowserFileObjectAction_DataAverageSingleFile
...
#Region "Style and Settings"
    ...
    Public Function QuickButtonInListEntry() As Button Implements iDataBrowser_FileObjectAction.QuickButtonInListEntry
        ...
        B.Image = My.Resources.average2_16
        Return B
    End Function
    ...
    Public ReadOnly Property QuickButtonToolTip As String Implements iDataBrowser_FileObjectAction.QuickButtonToolTip
        Get
            Return My.Resources.rFileObjectActions.TT_DataAverageSingleFile
        End Get
    End Property
    ...
    Public Function SingleFileActionMenuItem() As ToolStripMenuItem Implements iDataBrowser_FileObjectAction.SingleFileActionMenuItem
        ...
        M.Text = My.Resources.rFileObjectActions.CM_DataAverageSingleFile
        M.Image = My.Resources.average2_16
        Return M
    End Function
    ...
    Public Function MultipleFileActionMenuItem() As ToolStripMenuItem Implements iDataBrowser_FileObjectAction.MultipleFileActionMenuItem
        Dim M As New ToolStripMenuItem
        M.Text = My.Resources.rFileObjectActions.MM_DataAverageSingleFile
        M.Image = My.Resources.average2_16
        Return M
    End Function
...
#Region "Multiple file objects"
    ...
    Public Function MultipleFileActionCheckSettings() As Boolean Implements iDataBrowser_FileObjectAction.MultipleFileActionCheckSettings
        ...
        With My.Settings
            If .LastDataAveragingSingleFile_ColumnNames.Count <= 0 Or
               .LastDataAveragingSingleFile_NewColumnName = String.Empty Then
                Return False
            End If
        End With
        Return True
    ...
    Public Function MultipleFileAction_IndividualAction(ByRef FileObject As cFileObject) As Boolean Implements iDataBrowser_FileObjectAction.MultipleFileAction_IndividualAction
        ...
        ' Create tool.
        Dim Tool As New cSpectroscopyTableDataAverager(FileObject)

        ' Fetch the file.
        Dim LastSelectedColumns As New List(Of String)
        For Each S As String In My.Settings.LastDataAveragingSingleFile_ColumnNames
            LastSelectedColumns.Add(S)
        Next
        Tool.AverageColumnsWITHAutomaticFetching_Direct(LastSelectedColumns,
                                                        My.Settings.LastDataAveragingSingleFile_NewColumnName)
        Tool.SaveAveragedColumnToFileObject(My.Settings.LastDataAveragingSingleFile_NewColumnName)
        Return True
    End Function
...
#Region "Single file object"
    ...
    Public Function SingleFileAction(ByRef FileObject As cFileObject) As Boolean Implements iDataBrowser_FileObjectAction.SingleFileAction
        Dim Tool As New wDataAveragingSingleFile
