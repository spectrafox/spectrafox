Public Class cDataBrowserFileObjectAction_DataRegauger
...
#Region "Style and Settings"
    ...
    Public Function QuickButtonInListEntry() As Button Implements iDataBrowser_FileObjectAction.QuickButtonInListEntry
        ...
        B.Image = My.Resources.regauge_16
        Return B
    End Function
    ...
    Public Function SingleFileActionMenuItem() As ToolStripMenuItem Implements iDataBrowser_FileObjectAction.SingleFileActionMenuItem
        ...
        M.Text = My.Resources.rFileObjectActions.CM_DataRegauging_ByFit
    ...
    Public Function MultipleFileActionMenuItem() As ToolStripMenuItem Implements iDataBrowser_FileObjectAction.MultipleFileActionMenuItem
        Dim M As New ToolStripMenuItem
        M.Text = My.Resources.rFileObjectActions.MM_DataRegauging_ByFit
        M.Image = My.Resources.regauge_16
        Return M
    End Function
...
#Region "Multiple file objects"
    ...
    Public Function MultipleFileAction_IndividualAction(ByRef FileObject As cFileObject) As Boolean Implements iDataBrowser_FileObjectAction.MultipleFileAction_IndividualAction
        ...
        Tool.RenormalizeColumnWITHDerivation_Direct(My.Settings.LastRenormalization_SourceColumnX,
                                                    ...
                                                    My.Settings.LastRenormalization_Boundaries_xMin,
                                                    My.Settings.LastRenormalization_Boundaries_xMax)
        Tool.SaveRenormalizedColumnToFileObject(My.Settings.LastRenormalization_RenormColumnName)
        If My.Settings.LastRenormalization_SaveSmoothed Then Tool.SaveSmoothedColumnToFileObject(My.Settings.LastRenormalization_SmoothedColumnName)
        If My.Settings.LastRenormalization_SaveDerived Then Tool.SaveDerivatedColumnToFileObject(My.Settings.LastRenormalization_DerivedColumnName)
        Return True
    End Function
...
#Region "Single file object"
    ...
    Public Function SingleFileAction(ByRef FileObject As cFileObject) As Boolean Implements iDataBrowser_FileObjectAction.SingleFileAction
        Dim Tool As New wDataRenormalization2
