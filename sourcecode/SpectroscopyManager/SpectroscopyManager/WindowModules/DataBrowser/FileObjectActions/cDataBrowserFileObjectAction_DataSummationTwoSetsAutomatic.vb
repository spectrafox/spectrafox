...
Public Class cDataBrowserFileObjectAction_DataSummationTwoSetsAutomatic
...
#Region "Style and Settings"
    ...
    Public Function MultipleFileActionMenuItem() As ToolStripMenuItem Implements iDataBrowser_FileObjectAction.MultipleFileActionMenuItem
        ...
        M.Text = My.Resources.rFileObjectActions.MM_DataSummationTwoSets_Last
...
#Region "Multiple file objects"
    ...
    Public Function MultipleFileActionCheckSettings() As Boolean Implements iDataBrowser_FileObjectAction.MultipleFileActionCheckSettings
        ...
        With My.Settings
            If .LastDataSummationTwoSets_NewColumnName = String.Empty Or
               .LastDataSummationTwoSets_ColumnToSum = String.Empty Or
               .LastDataSummationTwoSets_ColumnToSumWith = String.Empty Or
               .LastDataSummationTwoSets_ReferenceFileFullPath = String.Empty Then

                Return False
            End If

            ' Check, if reference file exists
            If Not System.IO.File.Exists(.LastDataSummationTwoSets_ReferenceFileFullPath) Then
                Return False
            End If
    ...
    Public Function MultipleFileAction_IndividualAction(ByRef FileObject As cFileObject) As Boolean Implements iDataBrowser_FileObjectAction.MultipleFileAction_IndividualAction
        ...
        ' Get FileObject of reference file
        Dim oFile As New FileInfo(My.Settings.LastDataSummationTwoSets_ReferenceFileFullPath)
        Dim ReferenceFileObject As cFileObject = cFileObject.GetFileObjectFromPath(oFile)

        ' Create tool.
        Dim Tool As New cSpectroscopyTableDataSummerTwoSets(FileObject, ReferenceFileObject)

        ' Fetch the file.
        Tool.SumColumnWITHAutomaticFetching_Direct(My.Settings.LastDataSummationTwoSets_ColumnToSum,
                                                   My.Settings.LastDataSummationTwoSets_ColumnToSumWith,
                                                   My.Settings.LastDataSummationTwoSets_ScalingFactor,
                                                   My.Settings.LastDataSummationTwoSets_NewColumnName)
        Tool.SaveSummedColumnToFileObject(My.Settings.LastDataSummationTwoSets_NewColumnName)
        Return True
    End Function
