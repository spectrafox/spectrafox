Public Class cDataBrowserFileObjectAction_DataSummationOtherColumn
...
#Region "Multiple file objects"
    ...
    Public Function MultipleFileActionCheckSettings() As Boolean Implements iDataBrowser_FileObjectAction.MultipleFileActionCheckSettings
        ...
        With My.Settings
            If .LastDataSummation_NewColumnName = String.Empty Or
               .LastDataSummation_ColumnToSum = String.Empty Or
               .LastDataSummation_ColumnToBeSummedWith = String.Empty Then
                Return False
            End If
        End With
        Return True
    ...
    Public Function MultipleFileAction_IndividualAction(ByRef FileObject As cFileObject) As Boolean Implements iDataBrowser_FileObjectAction.MultipleFileAction_IndividualAction
        ...
        ' Create tool.
        Dim Tool As New cSpectroscopyTableDataSummer(FileObject)

        ' Fetch the file.
        Tool.SumColumnWITHAutomaticFetching_Direct(My.Settings.LastDataSummation_ColumnToSum,
                                                        CType(My.Settings.LastDataSummation_Method, cSpectroscopyTableDataSummer.SummationMode),
                                                        My.Settings.LastDataSummation_ColumnToBeSummedWith,
                                                        My.Settings.LastDataSummation_NewColumnName)
        Tool.SaveSummedColumnToFileObject(My.Settings.LastDataSummation_NewColumnName)
        Return True
    End Function
